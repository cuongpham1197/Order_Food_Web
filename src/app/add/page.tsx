...
const AddPage = () => {
  ...
  const upload = async () => {
    ...
    const res = await fetch("https://api.cloudinary.com/v1_1/dbnervhwm/image", {
      method: "POST",
  ...
  return (
    <div className="p-4 lg:px-20 xl:px-40 h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex items-center justify-center text-red-500">
      <form onSubmit={handleSubmit} className="flex flex-wrap gap-6">
        <h1 className="text-4xl mb-2 text-gray-300 font-bold">Thêm sản phẩm</h1>
        ...
        <div className="w-full flex flex-col gap-2 ">
          ...
          <input
            className="ring-1 ring-red-200 p-4 rounded-sm placeholder:text-red-200 outline-none"
            type="text"
            placeholder="Đồ uống/Thực phẩm/Đô ăn vặt/..."
            name="catSlug"
            onChange={handleChange}
          />
        </div>
